...
// Conversions between SL_Bus_velocity_controller_geometry_msgs_Twist and geometry_msgs::Twist

void convertFromBus(geometry_msgs::Twist* msgPtr, SL_Bus_velocity_controller_geometry_msgs_Twist const* busPtr)
{
...
void convertToBus(SL_Bus_velocity_controller_geometry_msgs_Twist* busPtr, geometry_msgs::Twist const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/Twist");
...
// Conversions between SL_Bus_velocity_controller_geometry_msgs_Vector3 and geometry_msgs::Vector3

void convertFromBus(geometry_msgs::Vector3* msgPtr, SL_Bus_velocity_controller_geometry_msgs_Vector3 const* busPtr)
{
...
void convertToBus(SL_Bus_velocity_controller_geometry_msgs_Vector3* busPtr, geometry_msgs::Vector3 const* msgPtr)
{
  const std::string rosMessageType("geometry_msgs/Vector3");
